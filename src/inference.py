...
def predict_im(filepath):
    ...
    return predicted_class, prediction_probability.item()

##this function is for flask where it takes byte image as argument
def predict_image(image_byte):
...
if __name__=='__main__':
  ...
  prediction,_ = predict_im(filepath)
